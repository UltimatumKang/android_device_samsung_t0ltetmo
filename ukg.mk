...
# device
$(call inherit-product-if-exists, device/samsung/t0ltetmo/full_t0ltetmo.mk)
...
PRODUCT_NAME := ukg_t0ltetmo
PRODUCT_MODEL := Samsung Galaxy Note 2
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.t0ltetmo.$(shell date +%m%d%y).$(shell date +%H%M%S)

# overrides
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_NUMBER=573038 \
    PRODUCT_NAME=t0ltetmo \
    TARGET_BUILD_TYPE=user \
    BUILD_VERSION_TAGS=release-keys \
    PRIVATE_BUILD_DESC="t0ltetmo-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/t0ltetmo:4.2.2/JDQ39/573038:user/release-keys"
